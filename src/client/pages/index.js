...
function Home({ tests }) {
  return (
    <>
      ...
      <div class="bg-blue-200 w-full overflow-hidden flex flex-row p-[112px_64px] box-border items-center justify-start gap-[80px] text-[56px]">
        <div class="flex-1 flex flex-col items-start justify-start gap-[24px]">
          <div class="self-stretch flex flex-col items-start justify-start gap-[24px]">
            <b class="self-stretch relative leading-[120%] inline-block">Grading Objective Questions with AI and Symatic Analysis</b>
            <div class="self-stretch relative text-lg leading-[150%] inline-block">
              chAI is an AI solution for grading objective questions. It uses
              advanced symantic analysis, including cohere, to accurately
          ...
          <div class="flex flex-row p-[16px_0px_0px] box-border items-start justify-start gap-[16px]">
            ...
            <button class="cursor-pointer [border:1px_solid_#fff] p-[12px_24px] bg-black box-border flex flex-row items-center justify-center">
      ...
      <div class="bg-blue-200 w-full overflow-hidden flex flex-col p-[112px_64px] box-border items-center justify-start gap-[80px] text-center">
        ...
        <div class="self-stretch flex flex-row items-start justify-center gap-[48px] text-xl">
          <div class="flex-1 flex flex-col items-center justify-start gap-[24px]">
            ...
            <div class="self-stretch flex flex-col items-start justify-start gap-[24px]">
              ...
              <div class="self-stretch relative text-base leading-[150%] inline-block">
                To get started with chAI, simply upload your set of objective
          ...
          <div class="flex-1 flex flex-col items-center justify-start gap-[24px]">
            ...
            <div class="self-stretch flex flex-col items-start justify-start gap-[24px]">
              ...
              <div class="self-stretch relative text-base leading-[150%] inline-block">
                Once the answers have been submitted, chAI uses advanced
                symantic analysis, including cohere, to evaluate the quality of
      ...
      <div class="bg-blue-200 w-full overflow-hidden flex flex-col p-[80px_64px] box-border items-center justify-start gap-[48px] text-lg">
