...
class EvaluateMarks():
    ...
    def _semantic_check(self):
        ...
        embeds = co.embed(
            texts=database[database.q_category == self.question_no][[
        ...
        similar_item_ids = search_index.get_nns_by_vector(
            user_input_embeds[0], 10, include_distances=True)
...
def run_checks():
    ...
    return [
        "The question is " + format(((1 - round(checks[0], 2)) * 100), '.2f') +
        "% similar to the answer", "The answer is grammatically correct"
